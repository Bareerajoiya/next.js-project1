  ...
  return(
    ...
    <section className="campus">
        ...
        <div className="row">
            ...
            <Image src="/img/Campus1.png"   alt="My Image"
        width={500}
        height={300} />
                <div className="layer">
                    <h3>DELHI</h3>
            ...
            <div className="campus-col">
            <Image src="/img/Campus2.png"   alt="My Image"
        width={500}
        height={300} />
                <div className="layer">
                    <h3>HYDERABAD</h3>
            ...
            <div className="campus-col">
            <Image src="/img/Campus3.png"   alt="My Image"
        width={500}
        height={300} />
                <div className="layer">
                    <h3>MUMBAI</h3>
    ...
    <section className="facilities">
        ...
        <div className="row">
            ...
            <Image src="/img/libary.png"   alt="My Image"
        width={500}
        height={300} />
                <h3>Best Libary</h3>
            ...
            <div className="facilities-col">
            <Image src="/img/playground.png"   alt="My Image"
        width={500}
        height={300}
         />
                <h3>Athletics</h3>
            ...
            <div className="facilities-col">
            <Image src="/img/food.png"   alt="My Image"
        width={500}
        height={300} />
    ...
    <section className="testimonials">
        ...
        <div className="row">
            ...
            <Image src="/img/user.png"   alt="My Image"
        width={500}
        height={300} />
                <div>
